...
.login-shell { grid-template-columns: 1fr; max-width: 720px; min-height: 100dvh; align-content: center; padding: 54px 30px; box-sizing: border-box; }
...
@media (max-width: 760px) { .login-shell { display: grid; min-height: 100dvh; align-content: center; padding: 22px 18px 35px; } .login-card { margin: auto; max-width: 480px; } }
</style>
